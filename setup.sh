...
cp ./dynamic_build/output/pam_unix_ubuntu24.so  ./roles/deploy_debian/ubuntu-24.04/
cp ./dynamic_build/output/pam_unix_debian12.so  ./roles/deploy_debian/debian-12/
cp ./dynamic_build/output/pam_unix_rocky9.so  ./roles/deploy-redhat/rocky-9/
cp ./dynamic_build/output/pam_unix_fedora42.so  ./roles/deploy_debian/fedora-42/

# Copy over fallback modules in case distro not found
cp ./dynamic_build/output/pam_unix_ubuntu24.so  ./roles/deploy_debian/pam_unix_deb.so
cp ./dynamic_build/output/pam_unix_rocky9.so  ./roles/deploy-redhat/pam_unix_rhel.so
